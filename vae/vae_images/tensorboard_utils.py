...
def log_to_tensorboard(writer, epoch, vae_model, predictors, train_loader, loss_vae, loss_total,
...
def log_reconstruction_to_tensorboard(vae, dataloader, device, writer, epoch, train_loss, predictors):
    vae.eval()
    ...
    with torch.no_grad():
        ...
        z_estimated = generate_estimated_z(predictors, z, device)
