...
from vae.vae_images.main_training import train_models
from vae.vae_images.tensorboard_utils import  log_reconstruction_to_tensorboard
from vae.vae_images.training_utils import setup_models, setup_optimizers
...
train_models(
    train_loader, vae_model, predictors,
    optimizer_vae, optimizers_predictors,
    num_epochs=1000, log_dir=log_dir, delta=0, beta=1,lambda_norm=0,
    log_tensorboard=True , device=device,rho=20)
